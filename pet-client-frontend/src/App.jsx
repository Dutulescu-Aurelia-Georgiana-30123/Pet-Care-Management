...
export default function App() {
  ...
  >
    ...
    >
      <div>
        <h1 style={{ margin: 0, fontSize: 22, color: '#111827' }}>🐾 Pet Care Client</h1>
        <small style={{ color: '#6b7280' }}>Logged in as {owner.name}</small>
      </div>
      <nav style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
        ...
        <Link style={{ color: '#4b5563', fontWeight: 500 }} to="/appointments">
          My Appointments
        </Link>
        <button
